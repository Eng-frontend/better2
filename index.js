...
input_test.addEventListener("click",function(){
  ...
  /*
  password_test.addEventListener("keyup", function() {
    document.getElementById("p_test_pass1").style.color = "red";
    document.getElementById("p_test_pass2").style.color = "red";
    document.getElementById("p_test_pass3").style.color = "red";
